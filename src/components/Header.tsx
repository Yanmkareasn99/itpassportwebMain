...
export default function Header({ title, subtitle }: HeaderProps) {
  ...
  return (
    <header className="sm:h-20 header-gradient border-b border-gray-100 dark:border-slate-700 flex flex-row items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-0 sticky top-0 z-10">
      <div className="flex-1 min-w-0">
        ...
        <h1 className="text-base sm:text-lg font-bold text-gray-800 dark:text-slate-100 leading-tight truncate">
          {title}
        </h1>
      </div>
