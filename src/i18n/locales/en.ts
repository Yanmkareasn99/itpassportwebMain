export const en = {
  ...
  "adminPage.pdfImportDescription": "Choose a question PDF and its answer key. Review the detected questions and answers, then download questions.csv and answer_choices.csv.",
