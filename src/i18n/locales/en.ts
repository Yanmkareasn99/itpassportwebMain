export const en = {
  ...
  "ui.battleRanking": "Battle Rankings",
  "ui.rankingHelp": "Ranked by wins, then by correct answers in battles only.",
  "ui.refreshRanking": "Refresh rankings",
  ...
  "adminPage.english": "English",
  "adminPage.vietnamese": "Vietnamese",
  "adminPage.announcementSeverity": "Type",
  "adminPage.announcementInfo": "Information",
  "adminPage.announcementWarning": "Warning",
  "adminPage.announcementUrgent": "Urgent",
  "adminPage.announcementPriority": "Priority",
  "adminPage.announcementStarts": "Starts at",
  "adminPage.announcementEnds": "Ends at (optional)",
  ...
  "adminPage.refreshAnnouncements": "Refresh announcements",
  "adminPage.noAnnouncements": "No announcements have been created yet.",
  "adminPage.untitledAnnouncement": "Untitled announcement",
  "adminPage.announcementNoEnd": "No end date",
  ...
  "loginPage.eyebrow": "Learn smarter",
  "loginPage.failedToCreateAccount": "Failed to create account: ",
  "loginPage.featureAiReview": "Review weak areas together with AI",
  ...
  "materialsPage.uploading": "Uploading…",
  "materialsPage.uploaded": "Material uploaded and shared.",
  "materialsPage.shareMaterial": "Share material",
  "materialsPage.shareType": "Material type",
  "materialsPage.uploadFile": "Upload file",
  "materialsPage.shareLink": "Share link",
  "materialsPage.sharing": "Sharing…",
  "materialsPage.link": "HTTPS link",
  "materialsPage.linkHelp":
    "Share a Google Drive, OneDrive, Dropbox, or other public HTTPS link. Check the provider's sharing permissions first.",
  "materialsPage.linkShared": "Material link shared.",
  "materialsPage.linkShareFailed": "Unable to share material link.",
  "materialsPage.invalidLink": "Enter a valid link.",
  "materialsPage.insecureLink": "The link must start with https://.",
  "materialsPage.linkTooLong": "The link must be 2,048 characters or shorter.",
  "materialsPage.openLink": "Open link",
  ...
  "settingsPage.chooseAvatarPreset": "Choose a preset avatar",
  ...
  "settingsPage.currentPasswordVerificationFailed": "The current password is incorrect or could not be verified",
  ...
  "practiceListPage.examDate": "Exam period",
  "adminPage.examDate": "Exam year and month",
  "adminPage.examYear": "Year",
  "adminPage.examMonthUnknown": "Month unknown",
  "adminPage.examYearInvalid": "Exam year must be between 1900 and 2100.",
  "adminPage.examMonthRequiresYear": "Select an exam year before selecting a month.",
  "adminPage.examDateRequired": "Please select the exam year and month.",
  "ui.examDate": "Exam period",
  ...
  "practiceQuestionPage.continueInAiChat": "Continue this conversation in AI Chat",
  "aiChatPage.practiceQuestionContext": "Practice question:\n{question}\n\nOptions:\n{options}\n\nMy answer: {selected}\nCorrect answer: {correct}",
  ...
  "adminPage.pdfManualCrop": "Crop question images",
  "adminPage.pdfManualCropTitle": "Crop images for question {number}",
  "adminPage.pdfCropInstructions":
    "Drag over the scanned preview to select an area, choose where it belongs, and add it. Repeat to create multiple crops.",
  "adminPage.pdfCropQuestionImage": "Question image",
  "adminPage.pdfCropChoiceImage": "Choice {choice} image",
  "adminPage.pdfCropTarget": "Add crop to",
  "adminPage.pdfAddCrop": "Add selected crop",
  "adminPage.pdfCrops": "Added crops",
  "adminPage.pdfNoCrops":
    "Draw a rectangle on the preview to add a crop.",
  "adminPage.pdfApplyCrops": "Apply crops",
  "adminPage.pdfApplyingCrops": "Applying crops...",
  "adminPage.pdfZoomIn": "Zoom in",
  "adminPage.pdfZoomOut": "Zoom out",
  "adminPage.pdfResetZoom": "Reset zoom",
  "adminPage.pdfCropTool": "Crop",
  "adminPage.pdfMoveTool": "Move",
  "adminPage.questionSearchOptions": "Question search options",
  "adminPage.clearFilters": "Clear filters",
  "adminPage.filterQuestionNumber": "Question number",
  "adminPage.anyQuestionNumber": "Any number",
  "adminPage.filterExamYear": "Exam year",
  "adminPage.anyExamYear": "Any year",
  "adminPage.filterQuestionImage": "Question image",
  ...
  "adminPage.uploadChoiceImage": "Add image",
  "adminPage.replaceChoiceImage": "Change image",
  "adminPage.removeChoiceImage": "Remove image",
  "adminPage.adminReview": "Admin review and editing status",
  "adminPage.reviewStatus": "Review status",
  "adminPage.reviewDraft": "Draft",
  "adminPage.reviewEditing": "Editing",
  "adminPage.reviewReady": "Ready for review",
  "adminPage.reviewNeedsChanges": "Needs changes",
  "adminPage.reviewApproved": "Approved",
  "adminPage.adminReviewMessage": "Message for other admins",
  "adminPage.adminReviewMessagePlaceholder": "Share what was changed, what still needs checking, or any concerns...",
  "adminPage.adminReviewHelp": "Only administrators can read this status and message.",
  "adminPage.noAdminMessage": "No admin message",
