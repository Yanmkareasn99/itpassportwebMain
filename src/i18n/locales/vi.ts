export const vi = {
  ...
  "materialsPage.shareMaterial": "Chia sẻ tài liệu",
  "materialsPage.shareType": "Loại tài liệu",
  "materialsPage.uploadFile": "Tải tệp lên",
  "materialsPage.shareLink": "Chia sẻ liên kết",
  "materialsPage.sharing": "Đang chia sẻ…",
  "materialsPage.link": "Liên kết HTTPS",
  "materialsPage.linkHelp":
    "Chia sẻ liên kết HTTPS công khai từ Google Drive, OneDrive, Dropbox hoặc dịch vụ khác. Hãy kiểm tra quyền chia sẻ trước.",
  "materialsPage.linkShared": "Đã chia sẻ liên kết tài liệu.",
  "materialsPage.linkShareFailed": "Không thể chia sẻ liên kết tài liệu.",
  "materialsPage.invalidLink": "Nhập một liên kết hợp lệ.",
  "materialsPage.insecureLink": "Liên kết phải bắt đầu bằng https://.",
  "materialsPage.linkTooLong": "Liên kết phải có tối đa 2.048 ký tự.",
  "materialsPage.openLink": "Mở liên kết",
  ...
  "adminPage.uploadChoiceImage": "Thêm ảnh",
  "adminPage.replaceChoiceImage": "Đổi ảnh",
  "adminPage.removeChoiceImage": "Xóa ảnh",
  "adminPage.adminReview": "Trạng thái chỉnh sửa và duyệt của quản trị viên",
  "adminPage.reviewStatus": "Trạng thái duyệt",
  "adminPage.reviewDraft": "Bản nháp",
  "adminPage.reviewEditing": "Đang chỉnh sửa",
  "adminPage.reviewReady": "Sẵn sàng để duyệt",
  "adminPage.reviewNeedsChanges": "Cần chỉnh sửa",
  "adminPage.reviewApproved": "Đã duyệt",
  "adminPage.adminReviewMessage": "Tin nhắn cho quản trị viên khác",
  "adminPage.adminReviewMessagePlaceholder": "Chia sẻ nội dung đã thay đổi, phần cần kiểm tra hoặc vấn đề cần lưu ý...",
  "adminPage.adminReviewHelp": "Chỉ quản trị viên mới có thể đọc trạng thái và tin nhắn này.",
  "adminPage.noAdminMessage": "Không có tin nhắn quản trị",
