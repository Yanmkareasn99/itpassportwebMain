export const ja = {
  ...
  "ui.settleBattle": "対戦結果を確定できません。再試行中…",
  "ui.battleNeedsServer": "オンライン対戦にはSupabaseの有効化が必要です。",
  "ui.createBattle": "対戦ルームを作成できませんでした。",
  "ui.joinBattle": "対戦ルームに参加できませんでした。",
  "ui.cancelBattle": "対戦ルームをキャンセルできませんでした。",
  "ui.submitBattle": "解答を送信できませんでした。再試行してください。",
  "ui.restorePractice": "練習セッションを復元できませんでした。",
  "ui.saveAnswer": "解答を保存できませんでした。再試行してください。",
  "ui.saveResults": "練習結果を保存できませんでした。再試行してください。",
  "ui.aiExplanation": "AI解説を取得できませんでした。再試行してください。",
  "ui.countMatches": "該当する問題数を取得できませんでした。",
  "ui.startPractice": "練習を開始できませんでした。",
  "ui.loadSubjects": "練習分野を読み込めませんでした。",
  ...
  "ui.wholeNumber": "{field}は{min}〜{max}の整数で入力してください。",
  "ui.timeLimit": "制限時間",
  "ui.passingScore": "合格点",
  "ui.battleCountInvalid": "問題数は1〜20問にしてください。",
  ...
  "ui.loading": "読み込み中…",
  "ui.retry": "再試行",
  "ui.backPractice": "練習に戻る",
  "ui.savingAnswer": "解答を保存中…",
  "ui.points": "ポイント",
  ...
  "ui.defaultWager": "賭けポイント",
  "ui.availableRooms": "参加可能なルーム",
  "ui.noRooms": "現在、待機中のルームはありません。",
  "ui.room": "ルーム #{id}",
  "ui.roomRules": "{count}問 | 1問{seconds}秒",
  "ui.pointAmount": "{count}ポイント",
  "ui.seconds": "{count}秒",
  "ui.waitingPlayer": "待機中のプレイヤー",
  "ui.opponent": "対戦相手",
  "ui.you": "あなた",
  "ui.resume": "再開",
  "ui.join": "参加",
  "ui.battleCount": "問題数（1〜20問）",
  ...
  "ui.settleHelp": "両者がすべての問題に解答すると、自動的に結果が確定します。",
  "ui.questionNumber": "第{count}問",
  "ui.correct": "正解",
  ...
  "ui.timeMinutes": "制限時間（分）",
  "ui.passingPercent": "合格点（%）",
  "ui.questionBankHelp": "設定した問題数以上の問題を登録してください。",
  "ui.saving": "保存中…",
  "ui.saveSettings": "設定を保存",
  "ui.pointRewards": "獲得ポイント設定",
  "ui.pointHelp": "ログイン・練習・模擬試験で獲得するポイントを設定します。",
  "ui.dailyLogin": "毎日のログイン",
  "ui.practiceCorrect": "練習の正解",
  ...
  "adminPage.english": "英語",
  "adminPage.vietnamese": "ベトナム語",
  "adminPage.announcementSeverity": "種類",
  "adminPage.announcementInfo": "お知らせ",
  "adminPage.announcementWarning": "注意",
  "adminPage.announcementUrgent": "緊急",
  "adminPage.announcementPriority": "優先度",
  "adminPage.announcementStarts": "開始日時",
  "adminPage.announcementEnds": "終了日時（任意）",
  ...
  "adminPage.refreshAnnouncements": "お知らせを更新",
  "adminPage.noAnnouncements": "お知らせはまだ作成されていません。",
  "adminPage.untitledAnnouncement": "タイトルなしのお知らせ",
  "adminPage.announcementNoEnd": "終了日時なし",
  ...
  "adminPage.duplicateQuestion": "問題を複製",
  ...
  "materialsPage.uploading": "アップロード中…",
  "materialsPage.uploaded": "教材を共有しました。",
  "materialsPage.shareMaterial": "教材を共有",
  "materialsPage.shareType": "教材の種類",
  "materialsPage.uploadFile": "ファイルをアップロード",
  "materialsPage.shareLink": "リンクを共有",
  "materialsPage.sharing": "共有中…",
  "materialsPage.link": "HTTPSリンク",
  "materialsPage.linkHelp":
    "Google Drive、OneDrive、Dropboxなどの公開HTTPSリンクを共有できます。先に共有権限を確認してください。",
  "materialsPage.linkShared": "教材リンクを共有しました。",
  "materialsPage.linkShareFailed": "教材リンクを共有できませんでした。",
  "materialsPage.invalidLink": "有効なリンクを入力してください。",
  "materialsPage.insecureLink": "リンクはhttps://から始めてください。",
  "materialsPage.linkTooLong": "リンクは2,048文字以内にしてください。",
  "materialsPage.openLink": "リンクを開く",
  "materialsPage.title": "タイトル",
  "materialsPage.file": "ファイル",
  "materialsPage.description": "説明（任意）",
  "materialsPage.fileHelp": "PDF、PNG、JPEG、DOCX、PPTX、XLSX · 最大20 MB",
  ...
  "settingsPage.currentPassword": "現在のパスワード",
  ...
  "settingsPage.currentPasswordVerificationFailed": "現在のパスワードが正しくないか、確認できませんでした",
  ...
  "practiceListPage.examDate": "試験年月",
  "adminPage.examDate": "試験年・月",
  "adminPage.examYear": "年",
  "adminPage.examMonthUnknown": "月不明",
  "adminPage.examYearInvalid": "試験年は1900年から2100年の間で入力してください。",
  "adminPage.examMonthRequiresYear": "月を選択する前に試験年を入力してください。",
  "adminPage.examDateRequired": "試験年と月を選択してください。",
  "ui.examDate": "試験年月",
  ...
  "practiceQuestionPage.continueInAiChat": "AIチャットでこの会話を続ける",
  "aiChatPage.practiceQuestionContext": "練習問題:\n{question}\n\n選択肢:\n{options}\n\n自分の回答: {selected}\n正解: {correct}",
  ...
  "adminPage.pdfManualCrop": "問題画像を手動で切り抜く",
  "adminPage.pdfManualCropTitle": "問{number}の画像を切り抜く",
  "adminPage.pdfCropInstructions":
    "スキャン画像上をドラッグして範囲を選び、追加先を選択して切り抜きを追加します。複数回繰り返せます。",
  "adminPage.pdfCropQuestionImage": "問題画像",
  "adminPage.pdfCropChoiceImage": "選択肢{choice}の画像",
  "adminPage.pdfCropTarget": "切り抜きの追加先",
  "adminPage.pdfAddCrop": "選択範囲を追加",
  "adminPage.pdfCrops": "追加した切り抜き",
  "adminPage.pdfNoCrops":
    "プレビュー上をドラッグして切り抜く範囲を選択してください。",
  "adminPage.pdfApplyCrops": "切り抜きを適用",
  "adminPage.pdfApplyingCrops": "切り抜きを適用中...",
  "adminPage.pdfZoomIn": "拡大",
  "adminPage.pdfZoomOut": "縮小",
  "adminPage.pdfResetZoom": "表示倍率をリセット",
  "adminPage.pdfCropTool": "切り抜き",
  "adminPage.pdfMoveTool": "移動",
  "adminPage.questionSearchOptions": "問題検索オプション",
  "adminPage.clearFilters": "フィルターをクリア",
  "adminPage.filterQuestionNumber": "問題番号",
  "adminPage.anyQuestionNumber": "すべての番号",
  "adminPage.filterExamYear": "試験年度",
  "adminPage.anyExamYear": "すべての年度",
  "adminPage.filterQuestionImage": "問題画像",
  ...
  "adminPage.uploadChoiceImage": "画像を追加",
  "adminPage.replaceChoiceImage": "画像を変更",
  "adminPage.removeChoiceImage": "画像を削除",
  "adminPage.adminReview": "管理者レビュー・編集状況",
  "adminPage.reviewStatus": "レビュー状況",
  "adminPage.reviewDraft": "下書き",
  "adminPage.reviewEditing": "編集中",
  "adminPage.reviewReady": "レビュー待ち",
  "adminPage.reviewNeedsChanges": "修正が必要",
  "adminPage.reviewApproved": "承認済み",
  "adminPage.adminReviewMessage": "他の管理者へのメッセージ",
  "adminPage.adminReviewMessagePlaceholder": "変更内容、確認が必要な点、懸念事項などを共有してください...",
  "adminPage.adminReviewHelp": "この状況とメッセージは管理者だけが閲覧できます。",
  "adminPage.noAdminMessage": "管理者メッセージなし",
