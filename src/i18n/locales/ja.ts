export const ja = {
  ...
  "ui.keepOpen": "このページを開いたままお待ちください。相手が参加すると対戦が始まります。",
  "ui.checkRoom": "ルームを確認",
  ...
  "materialsPage.fileHelp": "PDF、PNG、JPEG、WebP、テキスト、MP4 · 最大20 MB",
  ...
  "materialsPage.invalidType": "PDF、PNG、JPEG、WebP、テキスト、またはMP4ファイルを選んでください。",
  ...
  "settingsPage.helpAccountBody": "「アカウント」では、氏名・学籍番号・クラスの更新、表示言語の変更、目標試験日の設定、パスワードの変更ができます。",
